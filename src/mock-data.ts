/**
 * Mock data for Coyote Hills Regional Park, Fremont, CA (37.56°N, 122.06°W).
 * Replace with live API calls in production.
 */
import { StrataLayer, DeepTimeEra, Entity, LocationContext } from './types';
...
export const MOCK_LOCATION: LocationContext = {
  location: {
    lat: 37.5634,
    lng: -122.0617,
...
export const MOCK_STRATA_LAYERS: StrataLayer[] = [
  {
    key: 'atmosphere',
...
export const MOCK_DAY_ENTITIES: Entity[] = [
  {
    id: 'great-horned-owl',
...
export const MOCK_PHENOLOGY_ENTITIES: Entity[] = [
  // Bloom
  {
    id: 'pheno-poppy',
    commonName: 'California Poppy',
...
export const MOCK_DEEP_TIME_ERAS: DeepTimeEra[] = [
  {
    label: 'Today',
    yearsAgo: 0,
  ...
  },
  {
    ...
    color: '#8bc34a',
    narrative:
      'The last glacial period is ending. Sea level is roughly 60 m lower — San Francisco Bay does not exist; the Sacramento and San Joaquin Rivers flow through a broad river valley across the present bay floor. Tule elk, pronghorn, and grizzly bears roam the surrounding grasslands. The Ohlone\'s ancestors are settling along the bay margins, gathering shellfish and hunting with atlatls. Mammoths vanished here only recently.',
    fossils: [
