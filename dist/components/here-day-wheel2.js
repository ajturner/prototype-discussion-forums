...
const HereDayWheel = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return hereDayWheelCss; }
}, [1, "here-day-wheel", {
    "entities": [16],
    "localTime": [16],
    "selectedEntity": [32],
...
function defineCustomElement() {
  ...
  const components = ["here-day-wheel"];
  components.forEach(tagName => { switch (tagName) {
    case "here-day-wheel":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HereDayWheel);
      }
      break;
  } });
}

export { HereDayWheel as H, defineCustomElement as d };

//# sourceMappingURL=here-day-wheel2.js.map