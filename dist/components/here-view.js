...
import { d as defineCustomElement$7 } from './here-day-wheel2.js';
import { d as defineCustomElement$6 } from './here-deep-time2.js';
import { d as defineCustomElement$5 } from './here-mode-switcher2.js';
import { d as defineCustomElement$4 } from './here-phenology-wheel2.js';
import { d as defineCustomElement$3 } from './here-strata2.js';
import { d as defineCustomElement$2 } from './location-bar2.js';
...
const HereView$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return hereViewCss; }
}, [1, "here-view", {
    "activeMode": [32],
    "locationContext": [32],
    "loading": [32]
...
function defineCustomElement$1() {
  ...
  const components = ["here-view", "here-day-wheel", "here-deep-time", "here-mode-switcher", "here-phenology-wheel", "here-strata", "location-bar"];
  components.forEach(tagName => { switch (tagName) {
    case "here-view":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HereView$1);
      }
      break;
    case "here-day-wheel":
      if (!customElements.get(tagName)) {
...
const HereView = HereView$1;
const defineCustomElement = defineCustomElement$1;

export { HereView, defineCustomElement };
