 ...
 */
declare const MACROSTRAT_BASE = "https://macrostrat.org/api/v2";
 ...
 */
export declare function fetchColumn(_lat: number, _lng: number): Promise<MacrostratColumn | null>;
/**
 * Fetch stratigraphic units for a column.
 * Endpoint: GET /units?col_id=&format=json
 */
export declare function fetchUnits(_colId: number): Promise<MacrostratUnit[]>;
/**
 * Reconstruct paleogeographic coordinates for a modern coordinate at a given age (Ma).
 * Endpoint: GET /paleogeography?lat=&lng=&age=
 */
export declare function fetchPaleocoordinates(_lat: number, _lng: number, _ageMa: number): Promise<PaleogeographyPoint | null>;
