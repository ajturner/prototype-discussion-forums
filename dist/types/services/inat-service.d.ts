...
declare const INAT_BASE = "https://api.inaturalist.org/v1";
 ...
 */
export declare function fetchObservations(_lat: number, _lng: number, _strataLayer?: StrataLayerKey): Promise<InatObservation[]>;
/**
 ...
 */
export declare function fetchPhenologyHistogram(_taxonId: string, _placeId: string): Promise<number[]>;
/**
 * Fetch species list for a geographic bounding box.
 * TODO: call `${INAT_BASE}/observations/species_counts?nelat=…&nelng=…&swlat=…&swlng=…`
 */
export declare function fetchSpeciesList(_lat: number, _lng: number, _radiusKm?: number): Promise<Entity[]>;
export { INAT_BASE };
