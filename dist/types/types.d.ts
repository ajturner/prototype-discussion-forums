...
export type StrataLayerKey = 'atmosphere' | 'canopy' | 'understory' | 'ground' | 'soil-surface' | 'upper-soil' | 'mycorrhizal' | 'bedrock';
export type PhenologyCategory = 'bloom' | 'migration' | 'breed' | 'fruit' | 'hibernate' | 'emerge';
